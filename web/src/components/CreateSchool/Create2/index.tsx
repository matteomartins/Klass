...
function Create2() {
    const cards = [KaCalendar, KaCalendar, KaCalendar, KaCalendar, KaCalendar, KaCalendar, KaCalendar, KaCalendar, KaCalendar, KaCalendar, KaCalendar, KaCalendar, KaCalendar, KaCalendar, KaCalendar, KaCalendar]
                ...
                <div className="icons-container">
                    <div className="scroll-view">
                        ...
                        <div className="icons-content">
                            {cards.map(card => <IconCard color="#F68237" Icon={card} onClick={() => {}} />)}
                        </div>
                        </div>
                    </div>
